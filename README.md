...
- `{reactions:thumbs,myitemid}` — thumbs widget with a unique item identifier.
...
An item identifier is required if the context containing the reaction has more than one reaction instance.
